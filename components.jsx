      ...
      <div className="nav-inner">
        ...
        <div style={{display:'flex',alignItems:'center',gap:'10px'}}>
          <button
            ...
            style={{background:'none',border:'1px solid var(--border,rgba(0,0,0,0.15))',cursor:'pointer',padding:'5px 11px',borderRadius:'20px',color:'inherit',fontSize:'12px',letterSpacing:'0.04em',lineHeight:1,fontFamily:'var(--font-mono,monospace)'}}
          >
