              ...
              <>
                <div className="pd-stills">
                  {project.photos.map((p, i) => {
                    ...
                    const pos = typeof p === 'string' ? 'center center' : (p.pos || 'center center');
                    return (
                      <div key={i} className={`pd-still${i === 0 ? ' wide' : ''}`}>
                        <div className="thumb" style={{backgroundImage:`url(${url})`,backgroundSize:'cover',backgroundPosition:pos}}>
                          <div className="thumb-corners"><span>FRAME · 0{i + 1}</span><span>STILL</span></div>
                        </div>
                      </div>
                    );
                  })}
