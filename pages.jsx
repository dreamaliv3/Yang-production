      ...
      <section className="sec">
        <div className="wrap">
          <div className="sec-head">
            ...
            <a className="sec-link" style={{cursor:"pointer"}} onClick={() => go('work')}>VIEW ALL ↗</a>
          </div>
...
function WorkPage({ openProject }) {
  ...
  const filters = ['all', 'conference', 'trade show', 'brand', 'corporate', 'summit', 'awards', 'festival', 'workshop'];
...
function ContactPage() {
  ...
  const svcList = ['Conference Coverage','Highlight Reel','Same-day Cuts','Photography','Interviews','Brand Film'];
    ...
    <main className="page-fade">
      <section className="page-head">
        <div className="wrap">
          ...
          <p className="page-sub">A short brief is enough to start. We'll respond within one business day with a quote and timeline.</p>
        </div>
      </section>
          ...
          <div className="contact-grid">
            <form onSubmit={(e) => { e.preventDefault(); setSubmitted(true); }}>
              ...
              <div className="form-row">
                ...
                <div className="form-chips">
                  {['< S$10k','S$10–25k','S$25–50k','S$50k+','Open'].map(b => (
                    <button type="button" key={b} className="form-chip">{b}</button>
                  ))}
                </div>
              </div>
              <div className="form-row">
            ...
            <aside className="contact-info">
              ...
              <div className="contact-info-block">
                ...
                <div className="val">Singapore<br/><span style={{color:'var(--text-dim)',fontSize:'15px'}}>Available across APAC</span></div>
              </div>
              <div className="contact-info-block">
                <div className="lbl">Response time</div>
                <div className="val">Within <em>1 business day</em></div>
              </div>
              <div className="contact-info-block">
