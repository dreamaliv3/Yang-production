    ...
    <main className="page-fade">
      ...
      <section className="sec">
        <div className="wrap">
          ...
          <div className="work-grid">
            <div className="work-card span-4 tall"><div className="work-thumb"><div className="work-thumb-img"><div className="thumb" style={{backgroundImage:'url(https://images.pixieset.com/69644919/63f7a0824f0b643b50b85d0266e1b5b9-xxlarge.jpg)',backgroundSize:'cover',backgroundPosition:'center'}}><div className="thumb-corners"><span>STILL · 01</span><span>FRAME</span></div><div className="thumb-name" style={{fontSize:'18px',opacity:0.85}}>Conference floor</div></div></div></div></div>
            <div className="work-card span-4 tall"><div className="work-thumb"><div className="work-thumb-img"><div className="thumb" style={{backgroundImage:'url(https://images.pixieset.com/69644919/5522e4e148e0c9316556ed9cfbbc1c9e-xxlarge.jpg)',backgroundSize:'cover',backgroundPosition:'center'}}><div className="thumb-corners"><span>STILL · 02</span><span>FRAME</span></div><div className="thumb-name" style={{fontSize:'18px',opacity:0.85}}>Keynote</div></div></div></div></div>
            <div className="work-card span-4 tall"><div className="work-thumb"><div className="work-thumb-img"><div className="thumb" style={{backgroundImage:'url(https://images.pixieset.com/75124119/d89eb4d232abf7b518dca0a702dce466-xxlarge.jpg)',backgroundSize:'cover',backgroundPosition:'center'}}><div className="thumb-corners"><span>STILL · 03</span><span>FRAME</span></div><div className="thumb-name" style={{fontSize:'18px',opacity:0.85}}>Detail</div></div></div></div></div>
          </div>
